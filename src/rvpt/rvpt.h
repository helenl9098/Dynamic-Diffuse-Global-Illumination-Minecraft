...
public:
    ...
    struct IrradianceField
    {
        ...
        //alignas(16) glm::ivec3 probe_count = glm::ivec3(10, 10, 10);  // number of probes in x, y, z directions
        //int side_length = 3.0;    // side length of the cubes that encase the probe

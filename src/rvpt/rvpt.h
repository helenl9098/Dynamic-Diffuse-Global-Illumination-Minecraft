...
public:
    ...
    {
        alignas(16) glm::ivec3 probe_count = glm::ivec3(11, 11, 11); // number of probes in x, y, z directions
        int side_length = 10.0;                      // side length of the cubes that encase the probe
